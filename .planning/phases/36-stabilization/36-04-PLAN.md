...
must_haves:
  truths:
    ...
    - "User groups and guest management accessible from mobile settings"
  artifacts:
...
3. Create `e2e/tests/mobile/features.spec.ts`:
   ...
   - Test: "user groups manageable from mobile" (MOBI2-06)
     - Navigate to mobile settings
     - Find user groups section
     - Verify user groups list displays
     - Verify can view group details
     - Note: Full CRUD may require admin role

   - Test: "guest management accessible from mobile" (MOBI2-07)
     - Navigate to mobile settings (as admin)
     - Find guest management section
     - Verify guest list displays
     - Verify can view guest details and revocation options
  </action>
  <verify>
...
- MOBI2-06: User groups on mobile (features.spec.ts)
- MOBI2-07: Guest management on mobile (features.spec.ts)
