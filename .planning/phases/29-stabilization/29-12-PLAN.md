...
files_modified:
  - .planning/STATE.md
  - .planning/todos/pending/load-testing-typing-indicators.md
autonomous: false
...
must_haves:
  truths:
    ...
    - "TEST-06 and TEST-08 descope documented in STATE.md"
  artifacts:
    - path: ".planning/STATE.md"
      provides: "Documented descoped requirements"
      contains: "TEST-06|TEST-08"
  key_links: []
---
...
<task type="auto">
  <name>Task 3: Document descoped requirements</name>
  <files>.planning/STATE.md</files>
  <action>
Update STATE.md to document the descoped requirements with rationale:
...
- Future: Create `.planning/todos/pending/load-testing-typing-indicators.md` for tracking.
```

Also create the todo file for load testing:

```bash
cat > .planning/todos/pending/load-testing-typing-indicators.md << 'EOF'
...
```
  ...
  <verify>
1. STATE.md contains "TEST-06" and "TEST-08" with descope rationale
2. `.planning/todos/pending/load-testing-typing-indicators.md` exists
3. Both requirements are explicitly documented as descoped
  </verify>
  <done>
Descoped requirements documented in STATE.md with rationale, load testing todo created
  </done>
</task>
...
- TEST-06: Descoped - documented in STATE.md with rationale (existing tests remain, no regressions)
- TEST-07: BUG-26-01 fixed
- TEST-08: Descoped - documented in STATE.md, todo created for future load testing
