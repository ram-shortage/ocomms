...
6 todos pending - see `.planning/todos/pending/`
...
- Chats not updating in realtime (Next.js server action issue)
- Uploads not persisted and images 404 (needs Docker volume + security review)
